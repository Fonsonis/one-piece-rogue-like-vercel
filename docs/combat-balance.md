...
Se conserva el contenido (434 personajes, 11 sagas, 57 islas), las seis estadísticas base de cada personaje, las fórmulas de subida de nivel, las recompensas de EXP y los cinco multiplicadores de dificultad. Las mejoras persistentes, fusiones y guardados locales siguen funcionando.
...
- **54 pasivas explícitas**: una tabla conecta las descripciones y los modificadores. Se muestran también las pasivas reales de personajes de menos de cuatro estrellas. No se anuncia una pasiva ficticia cuando el personaje carece de ella. Las esquivas de Katakuri y Enel tienen contadores finitos; la evasión ordinaria está limitada al 60%.
...
- 188.356 emparejamientos dirigidos (434 × 434): datos válidos y posibilidad de infligir daño.
- 1.736 espejos: todos los personajes en niveles 5, 20, 50 y 99.
- 868 combates mixtos con dos semillas reproducibles. Los combates deben terminar dentro del límite de la prueba.
